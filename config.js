...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~aNt1yZSb#_GNpGegVhPUF8JCGUJVUQjQdnREL6f0IGrWuxwW8aPA",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "Mr_Hommie",  // Bot's display name
    MODE: process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50943029593",  // Owner's WhatsApp number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Mr_Hommie",     // Sticker pack name
